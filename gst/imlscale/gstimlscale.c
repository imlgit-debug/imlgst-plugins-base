...
#define GST_CAT_DEFAULT iml_scale_debug
GST_DEBUG_CATEGORY_STATIC (iml_scale_debug);
...
{
  if (!gst_element_register (plugin, "imlscale", GST_RANK_NONE,
          GST_TYPE_VIDEO_SCALE))
    return FALSE;

  GST_DEBUG_CATEGORY_INIT (video_scale_debug, "imlscale", 0,
      "imlscale element");
